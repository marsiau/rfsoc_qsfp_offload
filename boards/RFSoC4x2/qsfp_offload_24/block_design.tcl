...
\
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins packet_generator/S_AXI_Lite] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins netlayer_switch/S_AXI_CTRL] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins ps8_0_axi_periph/M05_AXI] [get_bd_intf_pins rfdc/s_axi]
  ...
  connect_bd_net -net Net [get_bd_pins clk_wiz_1/clk_333M] [get_bd_pins axis_ssr_converter_dac/aclk] [get_bd_pins axi_dma_dac/s_axi_lite_aclk] [get_bd_pins axi_dma_dac/m_axi_sg_aclk] [get_bd_pins axi_dma_dac/m_axi_mm2s_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins axis_tkeep_pack_0/aclk] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins rst_dac_333M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk]
  connect_bd_net -net axi_dma_dac_mm2s_introut [get_bd_pins axi_dma_dac/mm2s_introut] [get_bd_pins xlconcat_0/In1]
  ...
  connect_bd_net -net axis_fifo_uflow_ctrl_0_irq_underflow [get_bd_pins fifo_controller/irq_underflow] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins axi_dma_cmac/s_axi_lite_aclk] [get_bd_pins axi_dma_cmac/m_axi_mm2s_aclk] [get_bd_pins axi_dma_cmac/m_axi_s2mm_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins dma_fifo_rx/m_axis_aclk] [get_bd_pins dma_fifo_tx/s_axis_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins rst_333M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  connect_bd_net -net cmac_gt_txusrclk2 [get_bd_pins cmac/gt_txusrclk2] [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins dma_fifo_rx/s_axis_aclk] [get_bd_pins dma_fifo_tx/m_axis_aclk] [get_bd_pins netlayer_switch/aclk] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins rst_ps8_0_gt_tx/slowest_sync_clk] [get_bd_pins rx_fifo/m_axis_aclk] [get_bd_pins tx_fifo/s_axis_aclk] [get_bd_pins netlayer/ap_clk]
  ...
  connect_bd_net -net rfdc_clk_dac0 [get_bd_pins rfdc/clk_dac0] [get_bd_pins fifo_controller/aclk] [get_bd_pins axis_data_fifo_1/m_axis_aclk] [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins ps8_0_axi_periph/M08_ACLK] [get_bd_pins rfdc/s0_axis_aclk] [get_bd_pins rst_dac_153M6/slowest_sync_clk]
  connect_bd_net -net rst_307M2_peripheral_aresetn [get_bd_pins rst_307M2/peripheral_aresetn] [get_bd_pins axis_ssr_converter_adc/aresetn] [get_bd_pins packet_generator/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins rfdc/m2_axis_aresetn]
  connect_bd_net -net rst_307M3_peripheral_aresetn [get_bd_pins rst_dac_153M6/peripheral_aresetn] [get_bd_pins fifo_controller/aresetn] [get_bd_pins clk_wiz_1/resetn] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins rfdc/s0_axis_aresetn]
  connect_bd_net -net rst_dac_333M_peripheral_aresetn [get_bd_pins rst_dac_333M/peripheral_aresetn] [get_bd_pins axis_ssr_converter_dac/aresetn] [get_bd_pins axi_dma_dac/axi_resetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins axis_tkeep_pack_0/aresetn] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn [get_bd_pins rst_ps8_0_96M/peripheral_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins netlayer_switch/s_axi_ctrl_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins rfdc/s_axi_aresetn]
  ...
  connect_bd_net -net rst_ps8_0_gt_tx_peripheral_aresetn [get_bd_pins rst_ps8_0_gt_tx/peripheral_aresetn] [get_bd_pins dma_fifo_rx/s_axis_aresetn] [get_bd_pins netlayer_switch/aresetn] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins tx_fifo/s_axis_aresetn] [get_bd_pins netlayer/ap_rst_n]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_adc2 [get_bd_pins rfdc/clk_adc2] [get_bd_pins axis_ssr_converter_adc/aclk] [get_bd_pins packet_generator/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins rfdc/m2_axis_aclk] [get_bd_pins rst_307M2/slowest_sync_clk]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins cmac/gtwiz_reset_tx_datapath] [get_bd_pins cmac/gtwiz_reset_rx_datapath] [get_bd_pins cmac/core_rx_reset] [get_bd_pins cmac/core_tx_reset] [get_bd_pins cmac/core_drp_reset] [get_bd_pins cmac/drp_clk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins cmac/s_axi_aclk] [get_bd_pins cmac/init_clk] [get_bd_pins netlayer_switch/s_axi_ctrl_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/M07_ACLK] [get_bd_pins rfdc/s_axi_aclk] [get_bd_pins rst_ps8_0_96M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins rst_307M2/ext_reset_in] [get_bd_pins rst_333M/ext_reset_in] [get_bd_pins rst_dac_153M6/ext_reset_in] [get_bd_pins rst_dac_333M/ext_reset_in] [get_bd_pins rst_ps8_0_96M/ext_reset_in]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_dac/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_dac/Data_SG] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  ...
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_dac/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs fifo_controller/S_AXI_Lite/S_AXI_Lite_reg] -force
  ...
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs packet_generator/S_AXI_Lite/reg0] -force
  ...
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma_dac/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma_dac/Data_SG] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM]

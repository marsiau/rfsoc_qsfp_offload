...
## USER LED SWITCH
set_property PACKAGE_PIN AR11 [ get_ports "gpio_leds[0]" ]
set_property IOSTANDARD LVCMOS18 [ get_ports "gpio_leds[0]" ]

set_property PACKAGE_PIN AW10 [ get_ports "gpio_leds[1]" ]
set_property IOSTANDARD LVCMOS18 [ get_ports "gpio_leds[1]" ]

set_property PACKAGE_PIN AT11 [ get_ports "gpio_leds[2]" ]
set_property IOSTANDARD LVCMOS18 [ get_ports "gpio_leds[2]" ]

set_property PACKAGE_PIN AU10 [ get_ports "gpio_leds[3]" ]

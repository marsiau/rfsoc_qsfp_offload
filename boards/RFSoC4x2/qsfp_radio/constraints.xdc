...
## USER LED
set_property PACKAGE_PIN AR11 [ get_ports "trx_leds[0]" ]
set_property IOSTANDARD LVCMOS18 [ get_ports "trx_leds[0]" ]

set_property PACKAGE_PIN AW10 [ get_ports "trx_leds[1]" ]
set_property IOSTANDARD LVCMOS18 [ get_ports "trx_leds[1]" ]

set_property PACKAGE_PIN AT11 [ get_ports "trx_leds[2]" ]
set_property IOSTANDARD LVCMOS18 [ get_ports "trx_leds[2]" ]

set_property PACKAGE_PIN AU10 [ get_ports "trx_leds[3]" ]
set_property IOSTANDARD LVCMOS18 [ get_ports "trx_leds[3]" ]

### QSFP PHY LAYER CONTROL
set_property PACKAGE_PIN AM22 [ get_ports "trx_i" ]
set_property IOSTANDARD LVCMOS18 [ get_ports "trx_i" ]

set_property PACKAGE_PIN AL21 [ get_ports "trx_o[0]" ]
set_property IOSTANDARD LVCMOS18 [ get_ports "trx_o[0]" ]

set_property PACKAGE_PIN AN22 [ get_ports "trx_o[1]" ]
set_property IOSTANDARD LVCMOS18 [ get_ports "trx_o[1]" ]

set_property PACKAGE_PIN AK22 [ get_ports "trx_o[2]" ]
set_property IOSTANDARD LVCMOS18 [ get_ports "trx_o[2]" ]

## SPI -----------------------------------------------------------------------------------------

# SPI Clock (SCLK)
set_property PACKAGE_PIN AF16 [get_ports "spi_sclk"]
set_property IOSTANDARD LVCMOS18 [get_ports "spi_sclk"]

# SPI Master Out, Slave In (MOSI)
set_property PACKAGE_PIN AG17 [get_ports "spi_mosi"]
set_property IOSTANDARD LVCMOS18 [get_ports "spi_mosi"]

# SPI Master In, Slave Out (MISO)
set_property PACKAGE_PIN AJ16 [get_ports "spi_miso"]
set_property IOSTANDARD LVCMOS18 [get_ports "spi_miso"]

# SPI Slave Select (SS)
set_property PACKAGE_PIN AK17 [get_ports "spi_ss"]
...
#
### Synthesis -----------------------------------------------------------------------------------------
##set_property BLOCK_SYNTH.RETIMING 1 [get_cells plddr_i/ddr4_0]
##set_property BLOCK_SYNTH.STRATEGY {PERFORMANCE_OPTIMIZED} [get_cells plddr_i/ddr4_0]
##set_property MAX_FANOUT 32 [get_cells {plddr_i/ddr4_0/inst/u_ddr4_mem_intfc/u_ddr_mc/bgr[1].u_ddr_mc_group/txn_fifo_output_reg[*]}]
##set_property MAX_FANOUT 32 [get_cells {plddr_i/ddr4_0/inst/u_ddr4_mem_intfc/u_ddr_mc/bgr[1].u_ddr_mc_group/cas_fifo_wptr[*]*}]
